...
| `podSecurityContext.runAsUser` | User ID to run as | `4000` |
| `podSecurityContext.runAsGroup` | Group ID to run as | `4000` |
| `podSecurityContext.fsGroup` | Filesystem group ID | `4000` |
| `podSecurityContext.seccompProfile.type` | Seccomp profile type | `RuntimeDefault` |
| `securityContext.allowPrivilegeEscalation` | Allow privilege escalation | `false` |
| `securityContext.readOnlyRootFilesystem` | Read-only root filesystem | `true` |
| `securityContext.runAsNonRoot` | Run as non-root user | `true` |
| `securityContext.runAsUser` | User ID to run as | `4000` |
...
| Parameter | Description | Default |
|-----------|-------------|---------|
| `openshift.enabled` | Enable OpenShift-specific features | `false` |
| `openshift.route.enabled` | Create OpenShift Route | `false` |
...
- `examples/passthrough-auth.yaml` - Passthrough authentication
- `examples/static-auth.yaml` - Static authentication
- `examples/openshift.yaml` - OpenShift deployment
